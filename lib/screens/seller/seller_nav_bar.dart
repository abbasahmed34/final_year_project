...
import 'package:final_year_project/screens/seller/seller_add_listings.dart';
                  ...
                  ListTile(
                    onTap: (){
                      ...
                      Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => const BottomNavBar(), // Replace YourNextScreen with the screen you want to navigate to
                      ));
                    },
                    title: const Text("Return Buyer Mode",style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 16
